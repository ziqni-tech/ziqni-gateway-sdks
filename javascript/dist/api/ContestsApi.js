...
export default class ContestsApi {
  ...
  */
  ...
  getContestById(X_API_KEY, spaceName, id, opts, callback) {
    ...
    return this.apiClient.callApi('/api/v1/{spaceName}/contests/{id}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getContests(X_API_KEY, spaceName, opts, callback) {
    ...
    return this.apiClient.callApi('/api/v1/{spaceName}/contests', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getLeaderboardByContestId(X_API_KEY, spaceName, id, memberId, opts, callback) {
    ...
    return this.apiClient.callApi('/api/v1/{spaceName}/contests/{id}/leaderboard', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
