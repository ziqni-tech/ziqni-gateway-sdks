...
export default class SseApi {
  ...
  */
  ...
  subscribeSseChannelByMemberId(X_API_KEY, spaceName, memberId, callback) {
    ...
    return this.apiClient.callApi('/api/v1/{spaceName}/sse/{memberId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  subscribeSseChannelByMemberRefId(X_API_KEY, spaceName, memberRefId, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = SseMemberMessage;
    return this.apiClient.callApi('/api/v1/{spaceName}/sse/reference/{memberRefId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  subscribeSseChannelHeartbeatByMemberId(X_API_KEY, spaceName, memberId, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = SseMemberMessage;
    return this.apiClient.callApi('/api/v1/{spaceName}/sse/{memberId}/heartbeat', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  subscribeSseChannelHeartbeatByMemberRefId(X_API_KEY, spaceName, memberRefId, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = SseMemberMessage;
    return this.apiClient.callApi('/api/v1/{spaceName}/sse/reference/{memberRefId}/heartbeat', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
