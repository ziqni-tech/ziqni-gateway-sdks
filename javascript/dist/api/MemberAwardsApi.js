...
export default class MemberAwardsApi {
  ...
  */
  ...
  claimAwardByIdAndMemberId(X_API_KEY, spaceName, memberId, awardId, callback) {
    ...
    return this.apiClient.callApi('/api/v1/{spaceName}/members/{memberId}/award/{awardId}/award', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  claimAwardByIdAndMemberRefId(X_API_KEY, spaceName, memberRefId, awardId, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = MemberAwardByIdResponse;
    return this.apiClient.callApi('/api/v1/{spaceName}/members/reference/{memberRefId}/award/{awardId}/award', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getAwardByIdAndMemberId(X_API_KEY, spaceName, memberId, awardId, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = MemberAwardByIdResponse;
    return this.apiClient.callApi('/api/v1/{spaceName}/members/{memberId}/award/{awardId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getAwardByIdAndMemberRefId(X_API_KEY, spaceName, memberRefId, awardId, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = MemberAwardByIdResponse;
    return this.apiClient.callApi('/api/v1/{spaceName}/members/reference/{memberRefId}/award/{awardId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
