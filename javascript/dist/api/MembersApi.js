...
export default class MembersApi {
  ...
  */
  ...
  getMemberById(X_API_KEY, spaceName, id, callback) {
    ...
    return this.apiClient.callApi('/api/v1/{spaceName}/members/{id}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getMemberByRefId(X_API_KEY, spaceName, memberRefId, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = MemberResponse;
    return this.apiClient.callApi('/api/v1/{spaceName}/members/reference/{memberRefId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
