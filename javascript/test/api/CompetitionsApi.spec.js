...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGatewayApiClient.CompetitionsApi();
  });
  ...
  describe('CompetitionsApi', function() {
    describe('getCompetitionById', function() {
      it('should call getCompetitionById successfully', function(done) {
        //uncomment below and update the code to test getCompetitionById
        //instance.getCompetitionById(function(error) {
