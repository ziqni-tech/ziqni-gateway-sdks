...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGatewayApiClient.MemberMessage();
  });
  ...
  describe('MemberMessage', function() {
    it('should create an instance of MemberMessage', function() {
      ...
      //var instance = new @ZiqniTechGatewayApiClient.MemberMessage();
      //expect(instance).to.be.a(@ZiqniTechGatewayApiClient.MemberMessage);
    });
