...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGatewayApiClient.AchievementIssuedCount();
  });
  ...
  describe('AchievementIssuedCount', function() {
    it('should create an instance of AchievementIssuedCount', function() {
      ...
      //var instance = new @ZiqniTechGatewayApiClient.AchievementIssuedCount();
      //expect(instance).to.be.a(@ZiqniTechGatewayApiClient.AchievementIssuedCount);
    });
