...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGatewayApiClient.Member();
  });
  ...
  describe('Member', function() {
    it('should create an instance of Member', function() {
      ...
      //var instance = new @ZiqniTechGatewayApiClient.Member();
      //expect(instance).to.be.a(@ZiqniTechGatewayApiClient.Member);
    });
