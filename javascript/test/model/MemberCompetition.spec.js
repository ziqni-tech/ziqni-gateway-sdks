...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGatewayApiClient.MemberCompetition();
  });
  ...
  describe('MemberCompetition', function() {
    it('should create an instance of MemberCompetition', function() {
      // uncomment below and update the code to test MemberCompetition
      //var instance = new @ZiqniTechGatewayApiClient.MemberCompetition();
      //expect(instance).to.be.a(@ZiqniTechGatewayApiClient.MemberCompetition);
    });
