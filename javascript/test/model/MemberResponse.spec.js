...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGatewayApiClient.MemberResponse();
  });
  ...
  describe('MemberResponse', function() {
    it('should create an instance of MemberResponse', function() {
      ...
      //var instance = new @ZiqniTechGatewayApiClient.MemberResponse();
      //expect(instance).to.be.a(@ZiqniTechGatewayApiClient.MemberResponse);
    });
