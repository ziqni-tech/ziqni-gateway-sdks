...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGatewayApiClient.MainRule();
  });
  ...
  describe('MainRule', function() {
    it('should create an instance of MainRule', function() {
      // uncomment below and update the code to test MainRule
      //var instance = new @ZiqniTechGatewayApiClient.MainRule();
      //expect(instance).to.be.a(@ZiqniTechGatewayApiClient.MainRule);
    });
