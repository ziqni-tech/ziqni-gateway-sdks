...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGatewayApiClient.AchievementResponse();
  });
  ...
  describe('AchievementResponse', function() {
    it('should create an instance of AchievementResponse', function() {
      ...
      //var instance = new @ZiqniTechGatewayApiClient.AchievementResponse();
      //expect(instance).to.be.a(@ZiqniTechGatewayApiClient.AchievementResponse);
    });
