...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGatewayApiClient.Metadata();
  });
  ...
  describe('Metadata', function() {
    it('should create an instance of Metadata', function() {
      ...
      //var instance = new @ZiqniTechGatewayApiClient.Metadata();
      //expect(instance).to.be.a(@ZiqniTechGatewayApiClient.Metadata);
    });
