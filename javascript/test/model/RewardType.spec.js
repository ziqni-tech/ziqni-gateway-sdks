...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGatewayApiClient.RewardType();
  });
  ...
  describe('RewardType', function() {
    it('should create an instance of RewardType', function() {
      ...
      //var instance = new @ZiqniTechGatewayApiClient.RewardType();
      //expect(instance).to.be.a(@ZiqniTechGatewayApiClient.RewardType);
    });
