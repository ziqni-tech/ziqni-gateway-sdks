...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGatewayApiClient.DependantOn();
  });
  ...
  describe('DependantOn', function() {
    it('should create an instance of DependantOn', function() {
      ...
      //var instance = new @ZiqniTechGatewayApiClient.DependantOn();
      //expect(instance).to.be.a(@ZiqniTechGatewayApiClient.DependantOn);
    });
