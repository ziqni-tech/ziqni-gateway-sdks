...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGatewayApiClient.Scheduling();
  });
  ...
  describe('Scheduling', function() {
    it('should create an instance of Scheduling', function() {
      ...
      //var instance = new @ZiqniTechGatewayApiClient.Scheduling();
      //expect(instance).to.be.a(@ZiqniTechGatewayApiClient.Scheduling);
    });
