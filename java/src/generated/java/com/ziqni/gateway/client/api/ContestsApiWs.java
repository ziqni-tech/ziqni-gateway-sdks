...
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
    ...
    public ContestsApiWs(ApiClient apiClient, StreamingClient streamingClient, Duration readTimeout) {
        ...
        */
        public CompletableFuture<ContestByIdResponse> getContestById(String X_API_KEY, String spaceName, String id, String include, String lang, String uomKey) {
...
pathParam.put("id", id);
        ...
        CompletableFuture<ContestByIdResponse> result = new WsCompletableFuture(this.streamingClient, "/aapi/getContestById", request);
        return result;
        }
        /**
...
queryParam.put("round", round);
queryParam.put("optionsNumberOfEntrantsMaximum", optionsNumberOfEntrantsMaximum);
queryParam.put("optionsNumberOfEntrantsMinimum", optionsNumberOfEntrantsMinimum);
queryParam.put("optionsIsPublic", optionsIsPublic);
queryParam.put("optionsAutoStart", optionsAutoStart);
queryParam.put("optionsAutoStop", optionsAutoStop);
...
queryParam.put("optionsStrategiesRankingStrategyScoreDesc", optionsStrategiesRankingStrategyScoreDesc);
queryParam.put("optionsStrategiesRankingStrategyTimeDesc", optionsStrategiesRankingStrategyTimeDesc);
queryParam.put("optionsStrategiesRankingStrategyScoreFirst", optionsStrategiesRankingStrategyScoreFirst);
queryParam.put("optionsStrategiesRankingStrategyIgnoreTime", optionsStrategiesRankingStrategyIgnoreTime);
queryParam.put("optionsStrategiesRankingStrategyIgnoreScore", optionsStrategiesRankingStrategyIgnoreScore);
queryParam.put("optionsStrategiesScoringStrategyLimitUpdatesTo", optionsStrategiesScoringStrategyLimitUpdatesTo);
queryParam.put("optionsStrategiesScoringStrategySumBestXOf", optionsStrategiesScoringStrategySumBestXOf);
queryParam.put("optionsStrategiesScoringStrategyLastUpdateTimeStamp", optionsStrategiesScoringStrategyLastUpdateTimeStamp);
queryParam.put("optionsStrategiesScoringStrategyRecordTimeWhenSumReaches", optionsStrategiesScoringStrategyRecordTimeWhenSumReaches);
queryParam.put("optionsStrategiesStrategyType", optionsStrategiesStrategyType);
queryParam.put("created", created);
        ...
        CompletableFuture<ContestResponse> result = new WsCompletableFuture(this.streamingClient, "/aapi/getContests", request);
        return result;
        }
        /**
        ...
        * @throws ApiException if fails to make API call
        */
        public CompletableFuture<LeaderboardResponse> getLeaderboardByContestId(String X_API_KEY, String spaceName, String id, String memberId, Integer limit) {
        var request = new HashMap<String, Object>();
        var queryParam = new HashMap<String, Object>();
...
pathParam.put("id", id);
        ...
        CompletableFuture<LeaderboardResponse> result = new WsCompletableFuture(this.streamingClient, "/aapi/getLeaderboardByContestId", request);
        return result;
        }
        }
