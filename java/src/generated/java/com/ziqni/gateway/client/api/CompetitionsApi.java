...
public class CompetitionsApi {
   ...
   */
  public CompletableFuture<CompetitionByIdResponse> getCompetitionById(String X_API_KEY, String spaceName, String id, String include, String lang, String uomKey) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getCompetitionByIdRequestBuilder(X_API_KEY, spaceName, id, include, lang, uomKey);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getCompetitionById", localVarResponse));
            }
            try {
              return CompletableFuture.completedFuture(
                  memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<CompetitionByIdResponse>() {})
              );
            } catch (IOException e) {
   ...
   * @param lang Allows you to preview the label, description and terms and conditions of the competition in a requested language. Case sensitive (optional)
   * @param uomKey Adding a &#x60;?_uomKey&#x60; will give you the value of rewards converted to the specific Units Of Measure multiplier Case sensitive * The unit of measure type of currency provided has to be the same as the rewards. Otherwise, the value will remain the same.  Usage syntax:  &#x60;?_uomKey&#x3D;search_word&#x60; (optional)
   * @return CompletableFuture&lt;ApiResponse&lt;CompetitionByIdResponse&gt;&gt;
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<CompetitionByIdResponse>> getCompetitionByIdWithHttpInfo(String X_API_KEY, String spaceName, String id, String include, String lang, String uomKey) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getCompetitionByIdRequestBuilder(X_API_KEY, spaceName, id, include, lang, uomKey);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            ...
            try {
              return CompletableFuture.completedFuture(
                  new ApiResponse<CompetitionByIdResponse>(
  ...
  private HttpRequest.Builder getCompetitionByIdRequestBuilder(String X_API_KEY, String spaceName, String id, String include, String lang, String uomKey) throws ApiException {
    // verify the required parameter 'X_API_KEY' is set
    if (X_API_KEY == null) {
      throw new ApiException(400, "Missing the required parameter 'X_API_KEY' when calling getCompetitionById");
    }
    // verify the required parameter 'spaceName' is set
    if (spaceName == null) {
      throw new ApiException(400, "Missing the required parameter 'spaceName' when calling getCompetitionById");
    }
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getCompetitionById");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/api/v1/{spaceName}/competitions/{id}"
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<CompetitionResponse>> getCompetitionsWithHttpInfo(String X_API_KEY, String spaceName, List<String> id, Integer limit, Integer skip, String sortByFields, String include, String lang, String equal, String equalEqual, String lessThanEqual, String lessThanEqualEqual, String equalGreaterThan, String equalEqualGreaterThan, String optionsActualDatesEnd, String actualEnd, String productsProductRefId, String productRefId, String optionsProductsMetadataKey, String optionsProductsMetadataValue, String optionsProductsProductRefId, String status, Integer statusCode, List<String> optionsLimitEntrantsTo, List<String> limitEntrantsTo, String optionsScheduledDatesStart, String scheduledStart, String optionsScheduledDatesEnd, String scheduledEnd, String optionsActualDatesStart, String actualStart) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getCompetitionsRequestBuilder(X_API_KEY, spaceName, id, limit, skip, sortByFields, include, lang, equal, equalEqual, lessThanEqual, lessThanEqualEqual, equalGreaterThan, equalEqualGreaterThan, optionsActualDatesEnd, actualEnd, productsProductRefId, productRefId, optionsProductsMetadataKey, optionsProductsMetadataValue, optionsProductsProductRefId, status, statusCode, optionsLimitEntrantsTo, limitEntrantsTo, optionsScheduledDatesStart, scheduledStart, optionsScheduledDatesEnd, scheduledEnd, optionsActualDatesStart, actualStart);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder getCompetitionsRequestBuilder(String X_API_KEY, String spaceName, List<String> id, Integer limit, Integer skip, String sortByFields, String include, String lang, String equal, String equalEqual, String lessThanEqual, String lessThanEqualEqual, String equalGreaterThan, String equalEqualGreaterThan, String optionsActualDatesEnd, String actualEnd, String productsProductRefId, String productRefId, String optionsProductsMetadataKey, String optionsProductsMetadataValue, String optionsProductsProductRefId, String status, Integer statusCode, List<String> optionsLimitEntrantsTo, List<String> limitEntrantsTo, String optionsScheduledDatesStart, String scheduledStart, String optionsScheduledDatesEnd, String scheduledEnd, String optionsActualDatesStart, String actualStart) throws ApiException {
    // verify the required parameter 'X_API_KEY' is set
    if (X_API_KEY == null) {
      throw new ApiException(400, "Missing the required parameter 'X_API_KEY' when calling getCompetitions");
    }
    // verify the required parameter 'spaceName' is set
    if (spaceName == null) {
      throw new ApiException(400, "Missing the required parameter 'spaceName' when calling getCompetitions");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/api/v1/{spaceName}/competitions"
        .replace("{spaceName}", ApiClient.urlEncode(spaceName.toString()));
